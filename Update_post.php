                            ...
                            <div class="mb-3">
                               ...
                               $row=($result->fetch_assoc());
                                echo '<form id="updateForm" action="#" method="POST">>
                                    ...
                                    <!-- Message input-->
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" name="body" id="body" type="text" value="'.$row['body'].'" style="height: 10rem" data-sb-validations="required"></textarea>
                                ...
                                require 'connect.php';
                                    ...
                                    $sql = "UPDATE  post  SET name='$name', description='$description',body='$body'
                                    WHERE id= " .$id;
